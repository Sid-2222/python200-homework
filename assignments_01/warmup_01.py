...
print("As we can see from the question 1 values we did a alternative less than one tailed test and we can see that group b has higher mean and p-value : 0000007.7 so we can say its direction very less by chance")
